    ...
    <main>
      <div className="mx-10 my-10 flex flex-col items-center justify-center gap-10">
        ...
        <p className="text-xl md:w-1/2">
          ...
          equipped to handle a wide range of projects. We pride ourselves on
          delivering high quality workmanship and customer service to gaurentee
          your landscaping needs are met.
        </p>
        <Image
